...
void CFileView::OnContextMenu(CWnd* pWnd, CPoint point)
{
	...
	pWndTree->SetFocus();
	editorApp.GetContextMenuManager()->ShowPopupMenu(IDR_POPUP_EXPLORER, point.x, point.y, this, TRUE);
}
...
void CFileView::OnChangeVisualStyle()
{
	...
	m_wndToolBar.LoadBitmap(editorApp.m_bHiColorIcons ? IDB_EXPLORER_24 : IDR_EXPLORER, 0, 0, TRUE /* Locked */);

	m_FileViewImages.DeleteImageList();

	UINT uiBmpId = editorApp.m_bHiColorIcons ? IDB_FILE_VIEW_24 : IDB_FILE_VIEW;
